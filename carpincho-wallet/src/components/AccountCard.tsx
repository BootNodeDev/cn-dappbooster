          ...
          <div className="flex w-full items-center gap-2">
            ...
            <DropdownMenu.Root onOpenChange={handleAccountMenuOpenChange}>
              ...
              <DropdownMenu.Portal>
                ...
                >
                  <div className="font-mono text-[0.72rem] font-semibold uppercase tracking-eyebrow text-muted-foreground px-2 pt-1 pb-2">
                    Accounts
                  </div>
                  {accountsSorted.map((a) => (
                    ...
                    >
                      ...
                      >
                        ...
                        {a.isPrimary && (
                          <span className="shrink-0 font-mono text-[0.68rem] font-semibold uppercase tracking-eyebrow text-primary">
                            active
                          </span>
                        )}
                      </DropdownMenu.Item>
