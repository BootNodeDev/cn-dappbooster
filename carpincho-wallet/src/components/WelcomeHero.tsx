...
export const WelcomeHero = ({ description, logoSize = 132 }: WelcomeHeroProps): JSX.Element => (
  <div className="relative flex flex-col items-center text-center pt-4 pb-7">
    ...
    <div className="mt-4 font-display text-[2.75rem] font-semibold bg-[image:var(--bg-gradient-brand)] bg-clip-text text-transparent leading-[1.02] tracking-[-0.03em] lowercase animate-slide-up-and-fade [animation-delay:80ms] [animation-fill-mode:backwards]">
      carpincho
    </div>
