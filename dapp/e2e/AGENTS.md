...
- Use env overrides (`WALLET_GATEWAY_DEVKIT_URL`, `DAPP_URL`, `EXTENSION_PATH`) instead of hard-coding alternate targets. `WALLET_SERVICE_URL` remains a legacy alias.
