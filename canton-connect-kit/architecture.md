...
This package must not depend on the scaffold's dApp, wallet, or wallet-gateway-tools internals. Its stable boundary is the CIP-0103 provider surface plus `@canton-network/dapp-sdk`.
